        ...
        <section className="contact_component">
            ...
            <form onSubmit={this.formSubmit}>
                ...
                <div>
                    ...
                    {this.state.info ? this.state.info.error ?<button className="contact_reaction green" disabled>Mensaje Enviado</button> : <button disabled className="contact_reaction red">Mensaje No Enviado</button>:null}
                </div>
            </form>
        </section>
        );
